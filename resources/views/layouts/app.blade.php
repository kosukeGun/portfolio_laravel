                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button class="btn btn-primary me-md-2" type="button" onclick="location.href='/answerList'">解決策</button>
                                <button class="btn btn-primary me-md-2" type="button" onclick="location.href='/ranking'">ランキング</button>
